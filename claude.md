...
- **`schedule.toml`** (or `schedule.<label>.toml`; exactly one) — Timing: `[timing]` section with `steps`, `interval_seconds`, `setup_time_seconds`, `time_between_positions`.
